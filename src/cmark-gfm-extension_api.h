...
typedef delimiter *(*cmark_inline_from_delim_func)(
    cmark_syntax_extension *extension, cmark_parser *parser,
    cmark_inline_parser *inline_parser, delimiter *opener, delimiter *closer);
 ...
 */
CMARK_GFM_EXPORT int cmark_node_set_type(cmark_node *node,
 ...
 *  Copies 'content'.
 */
CMARK_GFM_EXPORT int cmark_node_set_string_content(cmark_node *node,
                                                   const char *content);
 ...
 */
CMARK_GFM_EXPORT cmark_syntax_extension *
cmark_node_get_syntax_extension(cmark_node *node);

/** Set the syntax extension responsible for creating 'node'.
 */
CMARK_GFM_EXPORT int
cmark_node_set_syntax_extension(cmark_node *node,
                                cmark_syntax_extension *extension);
...
/** Set the offset in bytes in the chunk being processed by the given inline
 * parser.
 */
CMARK_GFM_EXPORT
 ...
 * This only works where all n characters are in the single last child, and the
 * last child is CMARK_NODE_TEXT.
 */
CMARK_GFM_EXPORT
