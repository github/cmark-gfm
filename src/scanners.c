...
bufsize_t _scan_html_block_end_1(const unsigned char *p) {
  ...
  yy607 : { return (bufsize_t)(p - start); }
  yy608:
    yych = *++p;
    if (yybm[0 + yych] & 128) {
      goto yy588;
...
bufsize_t _scan_html_block_end_4(const unsigned char *p) {
  ...
  yy672 : { return (bufsize_t)(p - start); }
  yy673:
    yyaccept = 0;
    yych = *(marker = ++p);
    if (yych <= 0x7F)
...
bufsize_t _scan_link_title(const unsigned char *p) {
  ...
  yy728:
    ++p;
  yy729 : { return (bufsize_t)(p - start); }
  yy730:
    yych = *++p;
    if (yybm[0 + yych] & 16) {
      goto yy725;
  ...
  yy741:
    ++p;
  yy742 : { return (bufsize_t)(p - start); }
  yy743:
    yych = *++p;
    if (yybm[0 + yych] & 64) {
      goto yy739;
  ...
  yy754:
    ++p;
  yy755 : { return (bufsize_t)(p - start); }
  yy756:
    yych = *++p;
    if (yych <= 0xDF) {
      if (yych <= '[') {
...
bufsize_t _scan_atx_heading_start(const unsigned char *p) {
  ...
  yy782 : { return (bufsize_t)(p - start); }
  yy783:
    ++p;
    goto yy782;
  yy784:
...
bufsize_t _scan_dangerous_url(const unsigned char *p) {
  ...
  yy938:
    ...
    if (yych == 'i')
      goto yy942;
  yy939 : { return (bufsize_t)(p - start); }
  yy940:
    ++p;
    goto yy939;
  yy941:
