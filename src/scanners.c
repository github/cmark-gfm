...
bufsize_t _scan_liberal_html_tag(const unsigned char *p) {
  ...
  yy263 : { return (bufsize_t)(p - start); }
  yy264:
    yych = *++p;
    if (yych <= 0x7F)
      goto yy261;
...
bufsize_t _scan_html_block_end_1(const unsigned char *p) {
  ...
  yy501 : { return (bufsize_t)(p - start); }
  yy502:
    yych = *++p;
    if (yybm[0 + yych] & 128) {
      goto yy483;
...
bufsize_t _scan_html_block_end_2(const unsigned char *p) {
  ...
  yy529 : { return (bufsize_t)(p - start); }
  }
}
...
bufsize_t _scan_html_block_end_3(const unsigned char *p) {
  ...
  yy554 : { return (bufsize_t)(p - start); }
  }
}
...
bufsize_t _scan_html_block_end_4(const unsigned char *p) {
  ...
  yy560 : { return (bufsize_t)(p - start); }
  yy561:
    yyaccept = 0;
    yych = *(marker = ++p);
    if (yych <= 0x7F)
...
bufsize_t _scan_html_block_end_5(const unsigned char *p) {
  ...
  yy603 : { return (bufsize_t)(p - start); }
  }
}
...
bufsize_t _scan_link_title(const unsigned char *p) {
  ...
  yy624:
    ++p;
  yy625 : { return (bufsize_t)(p - start); }
  yy626:
    yych = *++p;
    if (yybm[0 + yych] & 64) {
      goto yy622;
  ...
  yy636:
    ++p;
  yy637 : { return (bufsize_t)(p - start); }
  yy638:
    yych = *++p;
    if (yych <= 0xDF) {
      if (yych <= '[') {
...
bufsize_t _scan_dangerous_url(const unsigned char *p) {
  ...
  yy780:
    ...
    if (yych == 'i')
      goto yy784;
  yy781 : { return (bufsize_t)(p - start); }
  yy782:
    ++p;
    goto yy781;
  yy783:
...
bufsize_t _scan_span_attrs(const unsigned char *p) {
  ...
  yy831 : { return (bufsize_t)(p - start); }
  yy832:
    yych = *++p;
    if (yych <= 0x7F) {
      if (yych <= '\r') {
